...
export const UserReviewCarousel = () => {
    const settings = {
        ...
        nextArrow: <img src={'../../../public/images/home_arrow_next.svg'} alt="" />,
        prevArrow: <img src={'../../../public/images/home_arrow_back.svg'} alt="" />
    }
        ;
    return (
        <div className="user-reviews-carousel-container">
            ...
            <Slider {...settings}>
                <div className="user-review-item">
                    ...
                    <div><span><img src={'../../../public/images/home_user.svg'} alt="" width="16px" /></span>Amit Sharma</div>
                </div>
                <div className="user-review-item">
                    <p>
                    ...
                    <div><span><img src={'../../../public/images/home_user.svg'} alt="" width="16px" /></span>Jyothi Bhatia</div>
                </div>
                <div className="user-review-item">
                    <p>
                    ...
                    <div><span><img src={'../../../public/images/home_user.svg'} alt="" width="16px" /></span>Avinash Kumar</div>
                </div>
            </Slider>
        </div>
    );
